package com.aotuman.common.permission
...
import com.aotuman.common.R
import com.permissionx.guolindev.request.RationaleDialog
import kotlinx.android.synthetic.main.custom_dialog_layout.*

@TargetApi(30)
class PermissionTipsDialog(context: Context, val message: String, val permissions: List<String>) : RationaleDialog(context,
